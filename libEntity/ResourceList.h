...
const QStringList STAND_UP_LIST = 
{
    ...
    "../images/Player/stand_up3",
    "../images/Player/stand_up4",
    "../images/Player/stand_up5",
...
const QStringList STAND_DOWN_LIST = 
{
    ...
    "../images/Player/stand_down3",
    "../images/Player/stand_down4",
    "../images/Player/stand_down5",
...
const QStringList STAND_LEFT_LIST = 
{
    ...
    "../images/Player/stand_left3",
    "../images/Player/stand_left4",
    "../images/Player/stand_left5",
...
const QStringList STAND_RIGHT_LIST = 
{
    ...
    "../images/Player/stand_right3",
    "../images/Player/stand_right4",
    "../images/Player/stand_right5",
...
const QStringList MOVE_UP_LIST = 
{
    ...
    "../images/Player/move_up3",
    "../images/Player/move_up4",
    "../images/Player/move_up5",
...
const QStringList MOVE_DOWN_LIST = 
{
    ...
    "../images/Player/move_down3",
    "../images/Player/move_down4",
    "../images/Player/move_down5",
...
const QStringList MOVE_LEFT_LIST = 
{
    ...
    "../images/Player/move_left3",
    "../images/Player/move_left4",
    "../images/Player/move_left5",
...
const QStringList MOVE_RIGHT_LIST = 
{
    ...
    "../images/Player/move_right3",
    "../images/Player/move_right4",
    "../images/Player/move_right5",
